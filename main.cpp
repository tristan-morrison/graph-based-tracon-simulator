...
int main(int argc, char *argv[])
{
    ...
    qmlRegisterType<MapQuickView>("Esri.GraphBasedTraconSimulator", 1, 0, "MapView");

    // Register the GraphBasedTraconSimulator (QQuickItem) for QML
    qmlRegisterType<GraphBasedTraconSimulator>("Esri.GraphBasedTraconSimulator", 1, 0, "GraphBasedTraconSimulator");
